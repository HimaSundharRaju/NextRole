...
| **Apply kit**       | Per job: a fit analysis, a tailored resume made from your main resume with a summary of what changed, a cover letter, answers to application questions, and a recruiter email plus LinkedIn note. Works for jobs found elsewhere too: paste the job description. "I've applied" saves a receipt of exactly what you sent. |
| **Auto-prepare**    | Pro and Concierge: strong new matches get a tailored resume and cover letter in the background, within a daily limit and your AI budget, and show up as "Ready to apply". You review and submit on the employer's site.                                                                                                   |
...
| **Plans and usage** | Free (job board and manual apply), Plus (tailored resumes and cover letters), Pro (plus auto-prepare) and Concierge. Each plan has monthly allowances shown as usage bars, and a spend cap as a backstop. AI work on jobs below a 70% match asks for confirmation first.                                                  |
